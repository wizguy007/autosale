...
<section id="main">
	<section class="container orderclass" style="text-align: center;">
		<?php	
			$sql = "SELECT * FROM `booking` WHERE `user_id`='".$_ID."'   ORDER BY `booking`.`booking_id` DESC";
			        ...
			        $status = $fetch['status'];
			         ...
			         echo "<tr>
				                ...
				                if($status == 'YES'){
				                	...
				                	echo "<td><a class='btn btn-default' href='btemplate.php?order_id=".$order_id."'>Print Slip</a> </td>";
